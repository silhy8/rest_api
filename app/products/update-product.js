...
$.getJSON("http://localhost:8080/rest_api/api/product/read_one.php?id=" + id, function(data){
...
$.getJSON("http://localhost:8080/rest_api/api/category/read.php", function(data){
...
$(document).on('submit', '#update-product-form', function(){
    ...
    $.ajax({
        url: "http://localhost:8080/rest_api/api/product/update.php",
        type : "POST",
